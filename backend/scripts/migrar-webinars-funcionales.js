...
// Webinars con enlace de vídeo funcional (validado el 2026-08-13
// con oEmbed de YouTube/Vimeo). El resto tiene el vídeo eliminado/privado.
...
async function migrar() {
  const webinars = JSON.parse(fs.readFileSync(DATA_PATH, 'utf-8'))
    .filter((w) => FUNCIONALES.has(w.codigo));

  console.log(`Cargando ${webinars.length} webinars con vídeo funcional...`);
